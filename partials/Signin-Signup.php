...
<div id="alertModal" class="modal">
    <div class="modal-content">
        <span class="close-button auth-close-btn">&times;</span>
        <div class="modal-form-container">
             <h2 id="alertModalTitle" class="modal-title" style="text-align: center;"></h2>
             <p id="alertModalMessage" style="margin-bottom: 25px; text-align: center;"></p>
             <button id="alertModalOk" class="btn btn-primary" style="display: block; margin: 0 auto;">OK</button>
        </div>
    </div>
</div>
...
/* Force Modals to be above absolutely everything (including fixed headers) */
.modal {
...
.auth-modal .modal-content {
    ...
    max-height: calc(100vh - 80px); /* Leave gap at top and bottom */
    position: relative;
}
...
.auth-close-btn:hover { color: #333; background: #fff; transform: scale(1.05); }
...
/* Ensure the form panel scrolls internally */
.auth-form-panel { 
    width: 55%; 
    padding: 40px 50px; 
    position: relative; 
    background-color: #ffffff; 
    overflow-y: auto; /* Independent scroll bar */
...
/* --- TIGHTER RESPONSIVE ADJUSTMENTS FOR AUTH MODALS --- */
@media (max-width: 768px) {
    .auth-modal .modal-content {
        ...
        max-width: 420px; 
        max-height: 85vh; 
        overflow: hidden; /* Keep hidden so close button is fixed */
        border-radius: 12px;
    }
    ...
    .auth-form-panel { 
        width: 100%; 
        padding: 35px 25px; 
        overflow-y: auto; /* Form scrolls inside the fixed box */
        max-height: 85vh;
    }
    
    .modal-title { font-size: 1.6rem; margin-bottom: 4px; }
    .modal-subtitle { font-size: 0.9rem; margin-bottom: 20px; }
    
    .modal-form .form-group { margin-bottom: 15px; }
    .modal-form .form-group label { font-size: 0.85rem; margin-bottom: 5px; }
    .modal-form .form-group input { padding: 12px; font-size: 0.95rem; }
    
    .modal-btn { padding: 12px; font-size: 1rem; margin-top: 10px; }
    .modal-bottom-text { margin-top: 15px; font-size: 0.85rem; }
    
    .auth-close-btn { top: 10px; right: 10px; font-size: 24px; width: 30px; height: 30px; }

    /* Single Form Modals tighter on mobile too */
    .single-form-modal {
        width: 90%;
        max-width: 420px;
        max-height: 85vh;
